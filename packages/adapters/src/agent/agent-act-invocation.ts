...
export function buildManagedRuntimeInstructions(request: AgentActResolutionRequest): string {
  const lines = [
    "You are resolving a runx agent_act request inside the managed runtime.",
...
export function buildManagedAgentActInvocation(
...
export function buildExecutionLocation(request: AdapterActInvocation): {
